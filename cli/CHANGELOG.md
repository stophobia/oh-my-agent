...
## [9.0.0](https://github.com/stophobia/oh-my-agent/compare/cli-v8.3.0...cli-v9.0.0) (2026-07-02)
...
* add telemetry opt-in to oma-config for all vendors ([22265cd](https://github.com/stophobia/oh-my-agent/commit/22265cd913310693418cfb1d04cdeaf04f00ecd5))
* add Windows support with PowerShell installer and link fallbacks ([#309](https://github.com/stophobia/oh-my-agent/issues/309)) ([31a72b6](https://github.com/stophobia/oh-my-agent/commit/31a72b63417efed508d98a64792856b174874f41))
* **agent:spawn:** expose --isolation=worktree for per-spawn git worktree ([8e5ebf5](https://github.com/stophobia/oh-my-agent/commit/8e5ebf5a53aa53c7cdba59351850de41c8db6b38))
* **agents:** add docs-curator agent for orchestrated docs sync ([e5ffa5b](https://github.com/stophobia/oh-my-agent/commit/e5ffa5b2d3a2a878a3ddb26c93b5e071e9c66849))
* **benchmarks:** add 5-axis multiaxis scoring system ([26b0ad8](https://github.com/stophobia/oh-my-agent/commit/26b0ad850cf751d439cae0a1273a0b6f0b683f8e))
* **benchmarks:** add multi-judge averaging for spec and visual axes ([c1c0f74](https://github.com/stophobia/oh-my-agent/commit/c1c0f7472ec019c6b21510796e8a050f75433635))
* **claude:** add skillListingBudgetFraction to recommended settings ([8fdf933](https://github.com/stophobia/oh-my-agent/commit/8fdf9336714330d41ce571e91b22df35a8f4bf97))
* **cli:** add antigravity (agy) as first-class vendor ([715e7b1](https://github.com/stophobia/oh-my-agent/commit/715e7b1c24d5b67376edb4af0b0084544efcaff4))
* **cli:** add model:check, model:probe, model:propose commands ([abd74fb](https://github.com/stophobia/oh-my-agent/commit/abd74fbb2dc7974a2818094c522f65ad7e115837))
* **cli:** align Cursor Agent auth, models, and dispatch ([2dfc258](https://github.com/stophobia/oh-my-agent/commit/2dfc25866f705ac3c1f501c98131eecd6ea5db3d))
* **cli:** auto-register skills from .agents/skills/ frontmatter ([050f16f](https://github.com/stophobia/oh-my-agent/commit/050f16fd40cda809fa83d19aed6a06edb8b3e45f))
* **cli:** expand install presets with web/mobile/research/content ([06a8c64](https://github.com/stophobia/oh-my-agent/commit/06a8c6406f6d5e618bdb071e8f98ca0614fd9af2))
* **cli:** generate .github/prompts wrappers for copilot vendor ([d9502ee](https://github.com/stophobia/oh-my-agent/commit/d9502ee1504ca3d3d3a90c27b467e0b4b7ffec83))
...
* **cli:** preserve user-upgraded effortLevel in claude settings ([4e0f50f](https://github.com/stophobia/oh-my-agent/commit/4e0f50f52f47e138587f86dc9063fc88daba8c2a))
* **cli:** show added/removed skills and workflows on update ([c03baf9](https://github.com/stophobia/oh-my-agent/commit/c03baf9f168037f302b32d70b0924ee59fdad828))
* **cli:** warn when oma-config targets the deprecated Gemini CLI ([11c5e28](https://github.com/stophobia/oh-my-agent/commit/11c5e2882c741081026ea02b512bbbf848023e72))
* **codex:** force-enable goals and child_agents_md features ([cee3377](https://github.com/stophobia/oh-my-agent/commit/cee3377cdaea2d47b161e650e3057a6cd26876ec))
* **config:** consolidate to model_preset single-file config ([294b8df](https://github.com/stophobia/oh-my-agent/commit/294b8df23b1dc3b9407f64041d0d421aa1caec5a))
* **cursor:** promote cursor to first-class vendor ([12a3c3d](https://github.com/stophobia/oh-my-agent/commit/12a3c3d823829cbfa901accbb8480864e34e0b58))
* **docs:** add 'oma docs i18n' for translation drift detection ([19c2efb](https://github.com/stophobia/oh-my-agent/commit/19c2efb719cc38e600241f968490ab2d7c3738cd))
* **docs:** add 'oma docs lint' for i18n style anti-patterns ([048804d](https://github.com/stophobia/oh-my-agent/commit/048804d2210152c46dcf841ef64248f847686e81))
* **docs:** introduce oma-docs verify and sync skill ([#326](https://github.com/stophobia/oh-my-agent/issues/326)) ([dc18e83](https://github.com/stophobia/oh-my-agent/commit/dc18e83f30a010812577bb83ff56b6990fb786b7))
* **docs:** swap tinyld for eld and add wrong-language rule ([89855df](https://github.com/stophobia/oh-my-agent/commit/89855dfbcd9ce38fc1008bef4ada45a84bccc632))
* **frontend:** ban framer-motion, enforce motion/react ([2810724](https://github.com/stophobia/oh-my-agent/commit/28107249f706fad8046de14fa99193d028bf5f6d))
* **frontend:** mandate next@16+ and react@19+, ban next &lt; 16 ([cd96046](https://github.com/stophobia/oh-my-agent/commit/cd9604644bbd456d37900775099f44df9ded94bc))
* **hooks:** add intent regex patterns and sanitize hardening ([f5800e1](https://github.com/stophobia/oh-my-agent/commit/f5800e1e34493ead0b3dfb6aa594e2400623c57b))
* **hooks:** resolve unknown slash commands via hidden skill lookup ([ef15f15](https://github.com/stophobia/oh-my-agent/commit/ef15f15ab340d4b0909135b3a81048e3b8e447f3))
* **hud:** wire HUD for Gemini CLI and Antigravity (agy) ([598e20b](https://github.com/stophobia/oh-my-agent/commit/598e20bbb06134c24c64a80a3695b14b14d69ebd))
* **image:** allow arbitrary WxH sizes within gpt-image-2 limits ([2acef68](https://github.com/stophobia/oh-my-agent/commit/2acef685c7715e8f83e638d4f2a1c9e9b79ee3eb))
* **image:** replace gemini vendor with keyless antigravity (agy) ([1d23e5a](https://github.com/stophobia/oh-my-agent/commit/1d23e5a0ab6e8f91057ca1eca1a431bbc9b736eb))
* **install:** add --yes flag for non-interactive install ([ff7ba68](https://github.com/stophobia/oh-my-agent/commit/ff7ba683b60edd7b9526a1edaf623e00e7f4072d))
* **install:** add Hermes Agent skill export with HOME consent gate ([#305](https://github.com/stophobia/oh-my-agent/issues/305)) ([6159cc6](https://github.com/stophobia/oh-my-agent/commit/6159cc600d6ec3413766576f5c02ddec814b149b))
* **install:** ensure docs/generated/ is gitignored after install ([37b9b67](https://github.com/stophobia/oh-my-agent/commit/37b9b678d0f835176d12793705708851ec6e4091))
* **io:** add gitignore module and auto-ignore docs/generated ([f033332](https://github.com/stophobia/oh-my-agent/commit/f033332b7c49fedb49189713fea5d1f462ed161f))
* **market:** add discover-competitors (LLM-first peer-entity candidates) ([e19ee27](https://github.com/stophobia/oh-my-agent/commit/e19ee27001dd8bafc8b988141a4763868a8fa23f))
* **market:** add oma-market skill with deterministic CLI pipeline ([3d42406](https://github.com/stophobia/oh-my-agent/commit/3d4240661aa3b202e660099c44a4d35245455122))
* **migrations:** add 010-rename-preset-keys auto-migration ([2c6724c](https://github.com/stophobia/oh-my-agent/commit/2c6724c8c0b41845d63762bf15b864a83a796262))
* **models:** upgrade default models to gpt-5.5 and qwen3.6-plus ([bbcd072](https://github.com/stophobia/oh-my-agent/commit/bbcd07273fd817083d8d86a7021b5efd7ef9c34f))
* **observability:** add WAF rule observability page ([07607ed](https://github.com/stophobia/oh-my-agent/commit/07607ed4a56594d4bc553d90b3e03621e120cb52))
* **oma-db:** add verification discrepancy audit guidance ([16a8130](https://github.com/stophobia/oh-my-agent/commit/16a8130a47406e9817d447d8c8822c989cdeaaf1))
* **oma-translator:** add tailing-negation rule and curly-quote check ([0697d6a](https://github.com/stophobia/oh-my-agent/commit/0697d6a8e82c0aa856f8c17b5a7b97905a365e75))
* **ralph:** re-verify all criteria each iteration with regression detection ([c6fd680](https://github.com/stophobia/oh-my-agent/commit/c6fd680667c9fe47bee20b66cafbb93d35644b1a))
* **readme:** add 'Works With Every Agent' vendor logos table ([e8b4211](https://github.com/stophobia/oh-my-agent/commit/e8b42113493f4e03f65979667dde93a48d0af518))
* **registry:** actionable error for unknown model slugs ([6467f0e](https://github.com/stophobia/oh-my-agent/commit/6467f0eeac150b6e1e53deb6517ffff372e17e54))
* **rules:** add serena MCP code-search guidance to vendor docs ([8ae45f9](https://github.com/stophobia/oh-my-agent/commit/8ae45f995864620269a6d3b41a3ea7a117b1500f))
* **scholar:** add oma scholar command and skill for paper sidecars ([6149a5a](https://github.com/stophobia/oh-my-agent/commit/6149a5aa9768713c82ec071c738ea2581ec766a4))
* **scripts:** add sns:devto weekly draft generator ([e47f72c](https://github.com/stophobia/oh-my-agent/commit/e47f72c520b35db2a8670d35414d4e06b31e8590))
* **search:** add clien, okky, duckduckgo (ddgs) handlers ([09bfbb4](https://github.com/stophobia/oh-my-agent/commit/09bfbb434a3be82963c2a73d783b2c5ee389a23c))
* **serena:** apply Claude .mcp.json and Gemini bridge override in oma update ([ad8d7d6](https://github.com/stophobia/oh-my-agent/commit/ad8d7d6a62fb109de4aa044ffabbc1e88b467b26))
* **serena:** migrate to uv tool install with per-vendor MCP contexts ([d79e51d](https://github.com/stophobia/oh-my-agent/commit/d79e51dbd44362f18bd7e2978a163e026cfa94b6))
* **serena:** opt-in serena-agent auto-upgrade during oma update ([c0e42d6](https://github.com/stophobia/oh-my-agent/commit/c0e42d6b2bb5c641056aae6d9839e29e4cbd154a))
* **skills/oma-frontend, benchmarks:** teach React 19 hook anti-patterns, refresh oma run ([91de585](https://github.com/stophobia/oh-my-agent/commit/91de585943b96ee708272b93d4e2f8804030b343))
* **skills:** add oma-academic-writer for academic prose ([8369a4c](https://github.com/stophobia/oh-my-agent/commit/8369a4cc6db6406c4537b8ec6c64b10c216041c8))
* **skills:** add oma-deepsec skill and /deepsec workflow ([56eb571](https://github.com/stophobia/oh-my-agent/commit/56eb571e92df7b48b27f7fa89678cad169fa4d22))
* **skills:** apply SSL framework and add oma-skill-creator ([18275f6](https://github.com/stophobia/oh-my-agent/commit/18275f63f452cd90b2262c6d2614bb40e758a94e))
* **skills:** strengthen oma-frontend + backend rules for benchmark gaps ([c384fd0](https://github.com/stophobia/oh-my-agent/commit/c384fd0cf8d10af24ebeef49c723a9063bfe0f85))
* **stats:** surface session-cost telemetry with vendor breakdown and USD estimate ([c31778d](https://github.com/stophobia/oh-my-agent/commit/c31778d3224efaf5c5933acb6b1e161aa80ad2e8))
* **translator:** add Diff-Sync Mode to oma-translator skill ([6647b9a](https://github.com/stophobia/oh-my-agent/commit/6647b9abcc53ca0492d6fca9cdecaa0f3c52d0bc))
* **vault:** os-keychain credential store via @napi-rs/keyring ([ec33b53](https://github.com/stophobia/oh-my-agent/commit/ec33b53d5f88059ba7bc8e4ae60962b9f642dd4f))
* **voice:** add oma-voice skill for local TTS/STT via Voicebox MCP ([3a0a7fb](https://github.com/stophobia/oh-my-agent/commit/3a0a7fb48c2ecbed80a425d837fa0a93f0e13dc8))
* **web:** enable PWA via @docusaurus/plugin-pwa ([da1362e](https://github.com/stophobia/oh-my-agent/commit/da1362e39423de6998ec85272c5975fcea859762))
* **workflows:** add /docs workflow wrapping oma-docs ([5512629](https://github.com/stophobia/oh-my-agent/commit/5512629ab66edc09dffab80d83fff16ed514e561))
* **workflows:** add recap workflow for oma-recap ([1d328ef](https://github.com/stophobia/oh-my-agent/commit/1d328ef4c539d9cb695a34c84ec37a6f445584ec))
* **workflows:** bias brainstorm and work loops toward structural fixes ([50ce165](https://github.com/stophobia/oh-my-agent/commit/50ce16541b2aa2fba9d6bbe9319a4497d56ca609))


### Bug Fixes

* **benchmarks:** build-report gallery row fuzzy match ([fcd67ed](https://github.com/stophobia/oh-my-agent/commit/fcd67ed834d85b9bbdbffb2d89fc6e49699cbb8a))
* **benchmarks:** drop gradient hero text in oma landing ([c9f6e13](https://github.com/stophobia/oh-my-agent/commit/c9f6e136558e8dda3d4d816deb2ad1c0f222ede2))
* **benchmarks:** macOS reproducibility + auto-score robustness + prompt move ([9439c0e](https://github.com/stophobia/oh-my-agent/commit/9439c0eddec5ea36823505ce8b3e9e79d4e51b30))
* **ci:** also pass NPM_CONFIG_TOKEN to bun publish ([0e51b8e](https://github.com/stophobia/oh-my-agent/commit/0e51b8e2e5cc09193b064122e2d2e1e4e9c04980))
* **ci:** prevent sync-manifest race conditions with concurrency and retry ([dc03410](https://github.com/stophobia/oh-my-agent/commit/dc03410e90775ebc23cf73d2dc23158ed3793a36))
* **ci:** use NODE_AUTH_TOKEN for bun publish auth ([44e7824](https://github.com/stophobia/oh-my-agent/commit/44e7824b08f313065da01e0ba0ba5359cc951e3c))
* **cli:** normalize Windows paths in docs resolver and self-update ([6345f36](https://github.com/stophobia/oh-my-agent/commit/6345f36b6bc13fc1ba835c8fd159d0e7b9576a53))
* **cli:** retry rmSync in update-cursor test to dodge Windows EBUSY ([8a2a7d7](https://github.com/stophobia/oh-my-agent/commit/8a2a7d7736bdceb417c4a89489167f5619543801))
* **cli:** use platform separator in isInIgnoredSet for Windows ([e4945b1](https://github.com/stophobia/oh-my-agent/commit/e4945b1d22fbc14adcfea3590b6dc3ffef021585))
* **codex:** rename codex_hooks → hooks and migrate deprecated key ([f3e6474](https://github.com/stophobia/oh-my-agent/commit/f3e64740724b2a50a4781d09bfec034ee90dbcaf))
* **config:** migrate source repo oma-config.yaml to model_preset schema ([babec96](https://github.com/stophobia/oh-my-agent/commit/babec968a2ef81cfbed52244fa954e7df35fab09))
* **docs:** clean up unused import and any-typed test fixtures ([05cc267](https://github.com/stophobia/oh-my-agent/commit/05cc2674fc85dae259fdb896017edbadab80e82b))
* **docs:** normalize i18n-drift paths to POSIX on Windows ([5184bda](https://github.com/stophobia/oh-my-agent/commit/5184bda30111c99566d849f5d79e2604a1f6be05))
* **docs:** normalize path separator on Windows for generated/ exclusion ([b85575e](https://github.com/stophobia/oh-my-agent/commit/b85575e5b68fe6e8d3665698dc7f62408a2bdbd2))
* **docs:** reduce extractor false positives and add resolve fallback prefixes ([e863875](https://github.com/stophobia/oh-my-agent/commit/e86387594a82674dfbd4ff4671ab80a6dcdb8623))
* **docs:** scope script refs to inline code and walk all ancestors ([01bd8ec](https://github.com/stophobia/oh-my-agent/commit/01bd8ecbaa4d62630513c42b2a5a3e1dbd82d249))
* **doctor:** bound CLI version probe with spawn timeout race ([edcf523](https://github.com/stophobia/oh-my-agent/commit/edcf523f384136d0838a881144428ed41042c5c4))
* **hooks/keyword-detector:** align CLI-invocation guard with vendor source of truth ([3c469dd](https://github.com/stophobia/oh-my-agent/commit/3c469dd3687d7aedc16ca86368c24f50a74791e2))
* **hooks/keyword-detector:** close fullwidth/hyphen bypasses and add CLI invocation guard ([3dfc2dc](https://github.com/stophobia/oh-my-agent/commit/3dfc2dc1d3998e29b1dc9223de237a3baf01b78c))
* **hooks/keyword-detector:** require explicit CLI signal for oma-family brands ([9be137a](https://github.com/stophobia/oh-my-agent/commit/9be137a2761748d158f5e26fd0fcf0c45d98cf03))
* **hooks:** inject SKILL.md for explicit Claude slash skills ([daaa41d](https://github.com/stophobia/oh-my-agent/commit/daaa41d2b3027fd1cda498cc8a81aa3c90d81ea6))
* **hooks:** normalize skill paths to POSIX form for Windows CI ([96a0044](https://github.com/stophobia/oh-my-agent/commit/96a004436e6488b7e85b6af70ca591bf87d187e1))
* **hooks:** suppress ralph false-positive on meta-discussion prompts ([88307cf](https://github.com/stophobia/oh-my-agent/commit/88307cff4a297e0ae4d850a35489a34fd6b35ff6))
* **image:** terminate codex exec args with -- before instruction ([#293](https://github.com/stophobia/oh-my-agent/issues/293)) ([85252cf](https://github.com/stophobia/oh-my-agent/commit/85252cfd094ba5a90045392a6b2341a2813857e8))
* **install,doctor:** bootstrap oma-config.yaml + fix doctor missing-skill repair ([#307](https://github.com/stophobia/oh-my-agent/issues/307)) ([f916ec6](https://github.com/stophobia/oh-my-agent/commit/f916ec6f7aca82e1e9a1fba0f5731ea80bd3b6c5))
* **install:** isolate test env from CI=true, mock missing copilot installer ([403f100](https://github.com/stophobia/oh-my-agent/commit/403f100375a5205f38c347317f89b1674e373415))
* **link:** generate copilot workflow prompts on oma link ([10e3c88](https://github.com/stophobia/oh-my-agent/commit/10e3c88041d856a9729b4c5f33eda6458184da92))
* **mcp:** switch serena context from antigravity to ide ([163a6f2](https://github.com/stophobia/oh-my-agent/commit/163a6f2143883124d02046a83765e2d1552bd08e))
* **migrations:** null-guard regex match result in 010 ([1b3cda3](https://github.com/stophobia/oh-my-agent/commit/1b3cda3a2f2ea7404f76b16d8d8d48dae482608e))
* **model-registry:** drop fake api_only fixture and startup warn ([7ee7caf](https://github.com/stophobia/oh-my-agent/commit/7ee7caf355507691ee3666136a65fde3db250ad2))
* **oma-frontend:** enforce Next.js 16 proxy.ts and ban middleware.ts ([39d2a54](https://github.com/stophobia/oh-my-agent/commit/39d2a54a9f94b23c5aafc335ff4af3327c99e9cb))
* **repo:** force LF line endings to unblock Windows CI lint ([78e83a4](https://github.com/stophobia/oh-my-agent/commit/78e83a48d6c267a94cec0c673713ceb9ea33f173))
* **scm:** quote skill description frontmatter ([2a225df](https://github.com/stophobia/oh-my-agent/commit/2a225df7dd5d39d3df39ff6029bda0c8a1919522))
* **skills/oma-frontend:** correct a11y anti-patterns in Card snippet ([a596060](https://github.com/stophobia/oh-my-agent/commit/a59606075ef3bbc0dae57dfde196573bbfc3f0fe))
* **skills:** expand oma-frontend keyword triggers ([2dddddd](https://github.com/stophobia/oh-my-agent/commit/2dddddd067ee047eebbd0233b805d356ce598eaa))
* **stats:** cache byVendor entry to satisfy noUncheckedIndexedAccess ([5abbf22](https://github.com/stophobia/oh-my-agent/commit/5abbf2282f3862948c6a1759ba2bda1d258f90a7))
* **stats:** pad before color so ANSI codes don't break table width ([e24d833](https://github.com/stophobia/oh-my-agent/commit/e24d833c84ad7b2b11fe00ee5cbcbd6254d795b2))
* **test:** normalize Windows backslashes in session-cost fs mocks ([17ea918](https://github.com/stophobia/oh-my-agent/commit/17ea9182978acf2606b2347b08eb3de6218d5718))
* **test:** satisfy SpawnSyncReturns typing in cursor recap tests ([847e41c](https://github.com/stophobia/oh-my-agent/commit/847e41c407121fe08f85a53aa1fc04a899df94a6))
* **test:** stub install_* functions in install-sh main pipe test ([e7af667](https://github.com/stophobia/oh-my-agent/commit/e7af6677bcdb54b9cbcb79fab32de737ba1c1eba))
* **test:** use POSIX paths for direct mock store access ([0f0994a](https://github.com/stophobia/oh-my-agent/commit/0f0994a999a51de3a7dd54bc6333bbc21df27918))
* **typecheck:** resolve @types/node v24/v25 conflict and strict test errors ([3ec0255](https://github.com/stophobia/oh-my-agent/commit/3ec02552a1a588583b1c140e46733dfae16e7d4c))


### Performance

* **web:** enable Docusaurus Faster (Rspack/SWC) and drop webpack override ([139378f](https://github.com/stophobia/oh-my-agent/commit/139378f497531c677a8e62136c445a59bb4e5881))


### Refactoring

* **benchmarks:** move design.md from docs/ to benchmarks/ ([79c4b36](https://github.com/stophobia/oh-my-agent/commit/79c4b36afdddab729b9d69234073a7640ccae7d0))
* **cli:** consolidate vendor list to a single source of truth ([ef03ac4](https://github.com/stophobia/oh-my-agent/commit/ef03ac4f558aad0e7e8b9266fb4624bb22ec7ffe))
* **cli:** merge cli-kit/ into utils/ ([71bf0b9](https://github.com/stophobia/oh-my-agent/commit/71bf0b94e603e27837195f312d2566843ec0553a))
* **cli:** move stats metrics to .agents/state ([1983d4d](https://github.com/stophobia/oh-my-agent/commit/1983d4d6dcf7e5e545948efc381b3769bd65df16))
* **cli:** remove oma export command ([f2cb7a7](https://github.com/stophobia/oh-my-agent/commit/f2cb7a75d8b06009743b0422685a1e57de8c3b05))
* **cli:** rename model preset keys (claude-only→claude, antigravity→mixed) ([681042d](https://github.com/stophobia/oh-my-agent/commit/681042d60a0912a5f7f80ebcbfcb46459e438e0a))
* **cli:** tighten lint hygiene, replace shell pipeline, modernize tests ([07fa9ba](https://github.com/stophobia/oh-my-agent/commit/07fa9bad519a4d9777fa79ad1d1db4cc6927d0f5))
* **hooks:** split types.ts into types-only + fs-utils + hook-output ([e3f48f1](https://github.com/stophobia/oh-my-agent/commit/e3f48f1886896907a7d2bd5539d31d07fa9f0a5d))
* **io:** split runtime-dispatch and add cursor vendor support ([5f83f79](https://github.com/stophobia/oh-my-agent/commit/5f83f79658fbfb37d5ad61fb84d105a140ac07cc))
* **link:** promote link() to vendor reconciliation kernel ([9e8a0b1](https://github.com/stophobia/oh-my-agent/commit/9e8a0b10a9fb58b75192933ac68f8177c0a4c304))
* **oma-frontend:** drop low-value resources, hoist stack files inline ([6ea9398](https://github.com/stophobia/oh-my-agent/commit/6ea93988ddfbfb3f70a5d8b621a992b09fe6e88f))
* **skills:** make intent-rules and examples english-only ([0f14076](https://github.com/stophobia/oh-my-agent/commit/0f14076bccaa5802e59d633897bb6bcbfc9be4b1))
* **update,install:** delegate vendor write to link kernel ([30d72af](https://github.com/stophobia/oh-my-agent/commit/30d72afcef64e7c54a57269f06906a9ac0ab7760))
* **workflows:** merge /exec-plan into /plan with structured docs/plans/ layout ([e634da3](https://github.com/stophobia/oh-my-agent/commit/e634da3b8d55bd7d5f4815b2a4742f9d8561f929))


### Documentation

* **academic-writer:** reframe HD-grade as publication-grade ([27150c0](https://github.com/stophobia/oh-my-agent/commit/27150c0ba5a2701c4a4dd11378f640efd8b2fb1a))
* add CITATION.cff with release-please auto-versioning ([f081b04](https://github.com/stophobia/oh-my-agent/commit/f081b048efa685ea0acb46032ecf8283cea59909))
* **api-contracts:** align _shared/api-contracts path to _shared/core/api-contracts ([1edd5bf](https://github.com/stophobia/oh-my-agent/commit/1edd5bf96e8ef30e8e6b7b36e6ba8ec407ff40a4))
* **benchmarks:** add generated report, screenshots, and harness outputs ([3472c54](https://github.com/stophobia/oh-my-agent/commit/3472c54bbb52bfc844a1df0bfbb9c7e1ebd36e89))
* **benchmarks:** add Korean translation README.ko.md ([182b69e](https://github.com/stophobia/oh-my-agent/commit/182b69e3f8ec6c3e0a5824f5bbc3d23cbffabfce))
* **benchmarks:** frame oma's lint -5 as intentional design principle ([3512aae](https://github.com/stophobia/oh-my-agent/commit/3512aae154942556b239818e2dfde51d062a36ca))
* **benchmarks:** re-capture oma + omc screenshots at consistent viewport ([fd0a74d](https://github.com/stophobia/oh-my-agent/commit/fd0a74d11db604b928abd0f7f22b1c6a7faf0b67))
* **benchmarks:** update README to reflect oma rerun (88 -&gt; 75.5) ([11b50f1](https://github.com/stophobia/oh-my-agent/commit/11b50f1058a42710c18e0b79b6b31bbb11f3f114))
* **claude:** regenerate CLAUDE.md rules table ([a7771db](https://github.com/stophobia/oh-my-agent/commit/a7771dbe53c6a79316a8e2f7d7a9c465111f38ce))
* **claude:** reorder rules table by usage frequency ([da8e196](https://github.com/stophobia/oh-my-agent/commit/da8e196eabc2e6c777d08aff4d3144ba7350f3f5))
* collapse APM install section into accordion across all locales ([cfb7e1f](https://github.com/stophobia/oh-my-agent/commit/cfb7e1f833b9c4cc0da603d0383330576ffeca50))
* **config:** cite OpenRouter slug format and CLI-only filter ([049577f](https://github.com/stophobia/oh-my-agent/commit/049577f08db20586eab2ac34be4dcdcd48266af5))
* **config:** move resolution-order comment below the keys it describes ([c90a33a](https://github.com/stophobia/oh-my-agent/commit/c90a33a0bfb302842acf9d3f42f7000d541bf8d6))
* drop hardcoded skill count and stale subagent paragraph ([424824b](https://github.com/stophobia/oh-my-agent/commit/424824b1502f7183e31b4de6d32ae84111d51726))
* list cursor-only preset across guides and i18n locales ([afe62b4](https://github.com/stophobia/oh-my-agent/commit/afe62b481a2b75f0bfe2e4a14aaa6660ab1dbedc))
* **oma-docs:** sync skill and ARCHITECTURE to no-LLM-call pattern ([e38dc57](https://github.com/stophobia/oh-my-agent/commit/e38dc57f7269c558c0d12e6a390047c799879e6e))
* **oma-frontend:** wire DESIGN.md as visual source of truth ([671dc60](https://github.com/stophobia/oh-my-agent/commit/671dc6017a97ab74e3ffacc7bcc29ea3c04c6935))
* **oma-pm:** unify plan secondary output to result-pm.md ([f797932](https://github.com/stophobia/oh-my-agent/commit/f797932fcb9ff85bccbd5dfef0489310b1a2fe27))
* **readme:** add localized references section with APA 7 citation ([ffb7aed](https://github.com/stophobia/oh-my-agent/commit/ffb7aed1ed735771debb8a734ebce6693a00e9eb))
* **readme:** add oma-academic-writer, oma-market, oma-voice rows ([e2598c9](https://github.com/stophobia/oh-my-agent/commit/e2598c9c2255fa56f6156e9e527df9034371cd7f))
* **readme:** add oma-docs row to skill table in all locales ([7dea938](https://github.com/stophobia/oh-my-agent/commit/7dea9388d3d1356a44b0cff223744729069a1a3a))
* **readme:** add oma-scholar to agent table ([45225f3](https://github.com/stophobia/oh-my-agent/commit/45225f30cc9cc7e96aa2fd4da7066f39d0c02c5f))
* **readme:** drop em dashes from agent team table ([c35a051](https://github.com/stophobia/oh-my-agent/commit/c35a051ce40b0d845ccc2c5cbc519e073c05b807))
* **readme:** drop knows sidecar mention from oma-scholar row ([f287bf0](https://github.com/stophobia/oh-my-agent/commit/f287bf0561cab12edd7c58da4a675e60f1925daa))
* **readme:** drop redundant '(Vercel deepsec)' parenthetical ([3901bb5](https://github.com/stophobia/oh-my-agent/commit/3901bb577e9292020d97f16a925a1b688cf1f465))
* **readme:** hide oma-coordination from agent team table ([817377e](https://github.com/stophobia/oh-my-agent/commit/817377eb03eab6a320d448011d93772a8cd49928))
* **readme:** list cursor-only preset in per-agent-models section ([230daef](https://github.com/stophobia/oh-my-agent/commit/230daef0a68294270cd9a7eb210a2d679787511b))
* **readme:** rewrite oma-docs row with sibling-matched form across locales ([254aa80](https://github.com/stophobia/oh-my-agent/commit/254aa80f38ff7b1799b3df8c1cbe7c8e9e697217))
* **readme:** sort CLI examples alphabetically and localize ([6a499b3](https://github.com/stophobia/oh-my-agent/commit/6a499b324132b1e1bd0714fc32be7856d33ee28e))
* **readme:** surface verify, quota_cap, ralph JUDGE, Exploration Loop, monorepo routing ([2558fb1](https://github.com/stophobia/oh-my-agent/commit/2558fb103cc185bd35d01d567226e3a081ddfc3c))
* **readme:** translate agent compatibility table across locales ([f5716ae](https://github.com/stophobia/oh-my-agent/commit/f5716aed2ae69cf55bd745447a33bf2ec9613126))
* regenerate vendor guides via oma link ([8e670d4](https://github.com/stophobia/oh-my-agent/commit/8e670d4497171e51494e76898c721cd6281d7d13))
* remove /tools and /pdf entries from README ([228fea9](https://github.com/stophobia/oh-my-agent/commit/228fea900a44402c78468562c5c2743dfff1911c))
* remove exec-plan and stack-set from slash command table ([85cf5f5](https://github.com/stophobia/oh-my-agent/commit/85cf5f578455dcdc9dfb6b5e96ba48626167e501))
* **skills/oma-translator:** add sibling-pattern check and mechanical-swap guard ([148e50a](https://github.com/stophobia/oh-my-agent/commit/148e50a609dbadd4e91564cd0d607bd275ae3a07))
* **skills:** cross-link observability handoffs across 8 skills ([6d5e99f](https://github.com/stophobia/oh-my-agent/commit/6d5e99f265e2e3073bf78b54f1f4d161fad69b20))
* update preset name references to new vendor scheme ([2f49afb](https://github.com/stophobia/oh-my-agent/commit/2f49afbab98e733fccef180cd43e1b25d46c4487))
